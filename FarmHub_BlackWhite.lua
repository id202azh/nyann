...
-- ============================================================
-- FULL SCRIPT: Black & White Farm Hub (redzlib fixed)
-- Theme: Galaxy (chữ trắng, toggle nền trắng + cục tròn đen)
-- ============================================================
	...
	function Window:MakeTab(paste, Configs)
		...
		function Tab:AddToggle(Configs)
			...
			local Toggle = InsertTheme(Create("Frame", Slider, {
				...
				Position = UDim2.new(0, 0, 0.5),
				AnchorPoint = Vector2.new(0, 0.5),
				BackgroundColor3 = Theme["Color Theme"]  -- đen trên nền trắng
			...
			local function SetToggle(Val)
				...
				if Default then
					...
					CreateTween({Toggle, "AnchorPoint", Vector2.new(1, 0.5), 0.25, true})
				else
					CreateTween({Toggle, "Position", UDim2.new(0, 0, 0.5), 0.25})
					CreateTween({Toggle, "BackgroundTransparency", 0.8, 0.25})
					CreateTween({Toggle, "AnchorPoint", Vector2.new(0, 0.5), 0.25, true})
				end
				WaitClick = false
		...
		function Tab:AddDropdown(Configs)
			...
			local AddNewOptions, GetOptions, AddOption, RemoveOption, Selected do
				...
				AddNewOptions = function(List, Clear)
					if Clear then
						for k,v in pairs(Options) do RemoveOption(k, v) end
					end
...
local Window = redzlib:MakeWindow({
    ...
    SaveFolder = "FarmHub_Config.json"
})

-- Đảm bảo dùng theme Galaxy (đen trắng)
redzlib:SetTheme("Galaxy")
...
TabMain:AddSection("Chọn Vũ Khí")

local SelectedWeapon = "None"
TabMain:AddDropdown({
    Name = "Chọn Vũ Khí",
    Description = "Chọn tool/weapon để farm",
    Options = {"None", "Katana", "Gun", "Sword", "Combat", "Special Weapon"},
    Default = "None",
    Flag = "SelectedWeapon",
...
TabMain:AddSection("Chế Độ Farm")

local FarmEnabled = false
TabMain:AddToggle({
    Name = "Auto Farm",
    Description = "Bật/tắt farm thường",
    Default = false,
    Flag = "AutoFarm",
    Callback = function(Value)
        FarmEnabled = Value
        if Value then
            print("Auto Farm: ON")
            -- Viết logic farm của mày vào đây
        else
            print("Auto Farm: OFF")
        end
    end
...
TabMain:AddSection("Cài Đặt Thêm")

TabMain:AddToggle({
    Name = "Auto Attack",
    Description = "Tự động đánh",
    Default = true,
    Flag = "AutoAttack",
    Callback = function(Value)
...
TabSettings:AddSection("Giao Diện")
...
TabSettings:AddParagraph({
    Title = "Thông tin",
    Text = "Theme: Black & White (Galaxy)\nToggle: Nền trắng + cục tròn đen\nChữ: Trắng"
})

print("Farm Hub loaded successfully!")
